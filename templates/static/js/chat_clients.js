document.addEventListener("DOMContentLoaded", () => {
    ...
    //         setTimeout(() => overlay.classList.add('show'), 15); // Thêm hiệu ứng fade-in
    //     }
    //     setTimeout(() => {
    ...
    //     return;
    // }
    let forumIdCurrent = null;
    const socket = io(API_CONFIG.getApiUrl().replace('/api','')); // Khởi tạo Socket.IO client
